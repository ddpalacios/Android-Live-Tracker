...
import com.example.cta_map.Activities.Fragment_main_activity.ResponsiveMap;
import com.example.cta_map.Activities.Navigation.ViewDataActivity;
...
//                        ctx.startActivity(intent);
                        ...
                        Intent intent = new Intent(ctx, ResponsiveMap.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
