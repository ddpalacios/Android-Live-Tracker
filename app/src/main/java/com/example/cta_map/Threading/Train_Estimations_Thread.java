    ...
    public void run() {
        ...
        synchronized (this.msg){
            ...
            while (this.msg.IsSending()) {
                ...
                if (this.msg.get_chosen_trains() == null || this.msg.getIgnored() == null || this.msg.getTargetContent() == null){ Log.e(Thread.currentThread().getName(), "Data is NULL");return; }
                if (this.msg.get_chosen_trains().size() == 0){ Log.e("No trains", "No Trains Available"); }
